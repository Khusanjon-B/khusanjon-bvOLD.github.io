...
const numCurrentProjects = 2;

const currentProjects = document.getElementById("currentProjects");

for (let i = 0; i < numCurrentProjects; i++) {

    const project = projects[totalProjects - i];
